      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-5)' }}>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-1)' }}>
              <a onClick={() => router.push('/report-bug')} style={{ fontSize: 'var(--text-2xs)', color: 'var(--accent)', cursor: 'pointer', fontWeight: 500 }}>
                <i className="fa-solid fa-bug" style={{ marginRight: '4px', fontSize: '0.6rem' }} /> Report a Bug
              </a>
              <a href="mailto:supplecostadmin@gmail.com" style={{ fontSize: 'var(--text-2xs)', color: 'var(--ink-4)', cursor: 'pointer', textDecoration: 'none' }}>
                <i className="fa-solid fa-envelope" style={{ marginRight: '4px', fontSize: '0.6rem' }} /> Contact Admin
              </a>
